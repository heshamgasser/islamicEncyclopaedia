...
import '../../models/hadith/hadith_category.dart';
...
class HadethTab extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder(
      future: HadithAPIFucnction.getHadithCategory(appProvider.languageCode),
        ...
        return ListView.separated(
            itemBuilder: (context, index) {
              return HadethCategoryItems(
                  categoryItem: hadithCategory[index].title ?? '',
                  categoryColor: AppColor.darkBlue,
                  categoryFunction: () {
                    Navigator.pushNamed(context, HadethList.routeName,
                        arguments: hadithCategory[index]);
                  });
            },
